...
function Wo_Time_Elapsed_String($ptime) {
    ...
    $datetime2 = date("Y-m-d H:i:s", $ptime);
    ...
    if($day == 0){
        if($hours == 0){
            return $min. ' ' .$wo['lang']['_time_m'];
        }else{
            return $hours. ' ' .$wo['lang']['_time_hrs'];
        }
    }
    if($day < 28 && $day > 0){
        return $day. ' ' .$wo['lang']['day'];
    }
    if($day > 28){
        return $month. ' ' .$wo['lang']['months'];
    }
    if($month > 11){
        return $years. ' ' .$wo['lang']['years'];
    }
