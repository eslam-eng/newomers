                 ...
                 <?php if ($updated == false) { ?>
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <li> [Added] Cache System, now your website speed is 80% faster, average load dropped from 1.2s to 0.15ms.</li>
                              <li> [Fixed] 4 security issues, in follow privacy, brutfoce login & two auth, XSS in messages using nodejs.</li>
                              <li> [Fixed] 2+ more minor bugs.</li>
                        </ul>
...
<script>
var queries = [
    "ALTER TABLE `Wo_AppsSessions` ADD INDEX(`time`);",
    "ALTER TABLE `Wo_Group_Members` ADD INDEX(`time`);",
    "ALTER TABLE `Wo_Group_Members` DROP INDEX `user_id`;",
    "ALTER TABLE `Wo_Group_Members` ADD INDEX( `user_id`, `group_id`, `active`);",
];
