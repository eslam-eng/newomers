               ...
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     ...
                     <div class="alert alert-danger"><strong>Important:</strong> Make sure to run <code>npm install</code> using SSH on ./nodejs folder once done so the packages will be updated.</div>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                        <li> [Fixed] contact us page on sunshien theme.</li>
                            <li> [Fixed] messages list not showing on phone in sunshine.</li>
                            <li> [Fixed] turn off / on notifications on sunshine theme.</li>
                            <li> [Fixed] notifications bell not showing on sunshine on profile page.</li>
                            <li> [Fixed] announcement text not showing on sunshine theme.</li>
                            <li> [Fixed] comments cannot be made on blogs. </li>
                            <li> [Fixed] users cannot be verified by moderators.</li>
                            <li> [Fixed] avatars cannot be changed in manage genders page in admin panel.</li>
                            <li> [Fixed] sorting by price doesn't work well on marketplace.</li>
                            <li> [Fixed] creating an article in the blog and publishing it, it does not show words with accented letters.(à,è,ì,ò,ù).</li>
                            <li> [Fixed] 10+ minor bugs in back and front end.</li>
                        </ul>
