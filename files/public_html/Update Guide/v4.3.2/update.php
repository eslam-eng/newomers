...
if (!empty($_POST['update_langs'])) {
    ...
    $monetization = $db->get(T_USER_MONETIZATION);
    if (!empty($monetization)) {
        foreach ($monetization as $key => $value) {
            $db->where('user_id',$value->user_id)->update(T_USERS,['have_monetization' => 1]);
        }
    }
                 ...
                 <?php if ($updated == false) { ?>
                  <div>
                     ...
                     <div class="setting-well">
                        ...
                        <li>[Improved] speed after v4.3 update.</li>
                                <li>[Improved] speed of search system in admin panel. </li>
                                <li>[Updated] few sections in sunshine theme (design).</li>
                                <li>[Fixed] add account page broken on both themes. </li>
                                <li>[Fixed] sometimes reels not loading more than 6 videos.</li>
                                <li>[Fixed] social login system.</li>
                                <li>[Fixed] showing dublicated transactions in wallet page.</li>
                                <li>[Fixed] if a feature is turned off, it is still showing in directory page.</li>
                                <li>[Fixed] comment section not showing in watch page.</li>
                                <li>[Fixed] video playing in background instead of lightbox in watch page.</li>
                                <li>[Fixed] sometimes photos were showing in watch page.</li>
...
<script>
var queries = [
    "ALTER TABLE `Wo_MonetizationSubscription` ADD COLUMN `expire` INT(10) NULL DEFAULT '0' AFTER `created_at`;",
    "INSERT INTO Wo_Config (name, value) VALUES ('have_reels', 0);",
    "alter table Wo_Users add have_monetization INT(10) NOT NULL DEFAULT '0';"
];
